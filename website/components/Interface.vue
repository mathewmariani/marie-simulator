  ...
  <div class="hstack gap-2">
    <div class="btn-group" role="group">
      ...
      <button
        @click="emit('reset')"
        class="btn btn-primary"
        :disabled="!flags.assembled || flags.running"
      >
    ...
    <div class="btn-group" role="group">
      ...
      <button
        @click="emit('run')"
        class="btn btn-primary"
        :disabled="!flags.assembled || flags.halted || flags.interrupted"
      >
    ...
    <div class="btn-group">
      ...
      <ul class="dropdown-menu">
        <li>
          <a @click="emit('filter', 'ascii')" class="dropdown-item">ASCII</a>
        </li>
        <li>
          <a @click="emit('filter', 'decimal')" class="dropdown-item"
            >Decimal</a
          >
        </li>
        <li>
          <a @click="emit('filter', 'hexadecimal')" class="dropdown-item"
            >Hexadecimal</a
          >
        </li>
        <li>
          <a @click="emit('filter', 'octal')" class="dropdown-item">Octal</a>
        </li>
      </ul>
    </div>
    ...
    <div class="input-group" role="group">
      <button
        @click="emit('settle', input)"
        class="btn btn-primary"
        :disabled="!flags.interrupted"
      >
        Settle
      </button>
      <button
