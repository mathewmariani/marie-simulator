  ...
  <div class="vstack gap-3 py-3">
    <div class="hstack gap-3">
      ...
      <a
        class="btn btn-link"
        target="_blank"
        href="https://github.com/mathewmariani/marie-simulator/blob/master/notes/cheatsheet.md"
        >Cheatsheet</a
      >
      <a
        class="btn btn-link"
        target="_blank"
        href="https://github.com/mathewmariani/marie-simulator/blob/master/notes/student_resource.md"
        >Resources</a
      >
      <a
        class="btn btn-link"
        target="_blank"
        href="https://github.com/mathewmariani/MARIE-Examples"
        >Example</a
      >
      <a
        class="btn btn-link"
        target="_blank"
        href="https://github.com/mathewmariani/marie-simulator"
        >Github</a
      >
    </div>
    <StatusComponent
