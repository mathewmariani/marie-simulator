...
**IR**, a 16-bit register that holds an instruction immediately preceding its execution.<br>
...
**MAR**, a 12-bit register that holds the memory address of an instruction or the operand of an instruction.<br>
...
## Acknowledgements
Thank you to Marco Schweighauser for his blog [post](https://www.mschweighauser.com/make-your-own-assembler-simulator-in-javascript-part1/)
